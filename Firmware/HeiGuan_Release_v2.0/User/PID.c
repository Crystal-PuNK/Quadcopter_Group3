...
void pidControl() {
    ...
    pidRoll = serialPIDcontrol(expRoll - angle.roll, GY86DataList.GY * RAD_TO_DEGREE, &rollOuter, &rollInner);
    pidPitch = serialPIDcontrol(expPitch - angle.pitch, GY86DataList.GX * RAD_TO_DEGREE, &pitchOuter, &pitchInner);
    ...
    // if (BLEcount==1000)
    // {
    //     BLE_Printf("\n motor1: ") ; BLE_SendNumber(motor1,4);
    //     BLE_Printf("\n motor2: ") ; BLE_SendNumber(motor2,4);
    //     BLE_Printf("\n motor3: ") ; BLE_SendNumber(motor3,4);
    //     BLE_Printf("\n motor4: ") ; BLE_SendNumber(motor4,4);
    //     BLE_Printf("\n pidRoll:") ; BLE_SendNumber(pidRoll,4);
    //     BLE_Printf("\n expRoll:") ; BLE_SendNumber(expRoll,4);
    //     BLE_Printf("\n roll: ")   ; BLE_SendNumber((int)angle.roll,4);
    //     BLEcount = 0; 
    // }
    // #endif
...
void TIM4_Init() {
	...
	TIM_TimeBaseInitStructure.TIM_Prescaler = 84 - 1; // 计数器频率为 84MHz
